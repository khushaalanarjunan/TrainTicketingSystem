...
public class ChooseReturnDateFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_choose_return_date, container, false);
    }
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            datePicker.setOnDateChangedListener(new DatePicker.OnDateChangedListener() {
                ...
                public void onDateChanged(DatePicker view, int year, int monthOfYear, int dayOfMonth) {
                    ...
                    Toast.makeText(getContext(), "fdsSelected Date: " + selectedDate, Toast.LENGTH_SHORT).show();

                    String currentUserUid = FirebaseAuth.getInstance().getCurrentUser().getUid();
                    databaseTickets.child(currentUserUid).child("tickets").child("returndate").setValue(selectedDate);
