...
import com.example.trainticketsystem_hashmapbeatstherest.PaymentMethodsDetailsActivity;
import com.example.trainticketsystem_hashmapbeatstherest.R;
import com.example.trainticketsystem_hashmapbeatstherest.TopUpDetailsActivity;
...
public class PaymentMethodsChildAdapter extends RecyclerView.Adapter<PaymentMethodsChildAdapter.ItemViewHolder> {
    ...
    public ItemViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view  = LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_payment_method_child , parent , false);
    ...
    public void onBindViewHolder(@NonNull ItemViewHolder holder, int position) {
        ...
        if (isExpandable){
            holder.mArrowImage.setImageResource(R.drawable.right_arrow_24);
        }else{
